...
if __name__ == "__main__":
    ...
    org=cv2.imread(r'C:\Users\Harshith\Desktop\image_scenec.jpg',0)
    ref=cv2.imread(r'C:\Users\Harshith\Desktop\car_cropped.jpg',0)
    objects=[]

    base={"name":'image_scenec','image':org}
    object={'name':'car_cropped','image':ref}
